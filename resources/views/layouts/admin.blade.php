...
@yield('style')
    ...
    <link href="{{asset('assets/plugins/custom/datatables/datatables.bundle.rtl.css')}}">
                ...
                <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                            ...
                            <a href="{{route('admin.index')}}" class="font-weight-bolder btn-sm">الرئيسية </a>
|
                            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@yield('mainTitle')</h5>
                            <!--end::Page Title-->
                            <!--begin::Actions-->
                            <!--end::Actions-->
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="" target="_blank" class="text-dark-75 text-hover-primary">IntoShip</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
...
{{--                <div class="text-muted mt-1">Application Developer</div>--}}
                <div class="navi mt-2">
                    ...
                    <a href="{{route('logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">@lang('lang.logout')</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{route('admin.settings.getProfile')}}" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">@lang('lang.MyProfile')</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
            ...
            <a href="custom/apps/user/profile-3.html" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">@lang('lang.ChangePassword')</div>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{url('assets/media/stock-600x400/img-1.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{url('assets/media/stock-600x400/img-2.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{url('assets/media/stock-600x400/img-3.jpg')}}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{url("assets/media/svg/misc/015-telegram.svg ")}}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{url("assets/media/svg/misc/014-kickstarter.svg")}}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
